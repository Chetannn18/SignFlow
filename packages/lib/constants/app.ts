...
export const SUPPORT_EMAIL = env('NEXT_PUBLIC_SUPPORT_EMAIL') ?? 'support@signflow.com';
...
export const DOCUMENSO_CLOUD_ENTERPRISE_CTA_URL = 'mailto:support@signflow.com';
