            ...
            <AnimatePresence mode="wait" initial={false}>
              ...
              >
                ...
                <span className="truncate">
                  {isBranded ? <Trans>Sending from your domain</Trans> : <Trans>Sending from signflow.com</Trans>}
                </span>
              </motion.div>
            </AnimatePresence>
          </div>
              ...
              <div className="min-w-0">
                <div className="font-medium text-sm">
                  <AnimatePresence mode="wait" initial={false}>
                    ...
                    >
                      <span className="min-w-0 truncate">{isBranded ? brandedSender.name : 'SignFlow'}</span>
                ...
                <div className="font-mono text-muted-foreground text-xs">
                  <AnimatePresence mode="wait" initial={false}>
                    <motion.p
                      ...
                      className="truncate"
                    >
                      {isBranded ? brandedSender.email : 'noreply@mail.signflow.com'}
                    </motion.p>
                  </AnimatePresence>
                </div>
              </div>
